...
void InterGPU::apply(char *func, unsigned input_deviceID, unsigned output_deviceID, unsigned int size, int chip_id, unsigned int sub_partition_id, char* is_write) {
    file.open("remote.txt", std::ios::app);
    if(file.is_open()){
